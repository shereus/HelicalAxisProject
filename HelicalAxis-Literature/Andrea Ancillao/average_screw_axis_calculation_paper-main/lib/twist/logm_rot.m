...
% Output:
%   omega_skew = a (3x3) skew-symmetric matrix of the rotational velocity vector omega
%
% Note: better than doing logm(R) since it is a closed-form analytic expression
%
% Adapted from Erwin's code: https://gitlab.kuleuven.be/robotgenskill/python_projects/extendedqr/-/blob/master/src/extendedqr/SO3.py
%
